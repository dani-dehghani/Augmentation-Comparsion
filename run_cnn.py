...
dataset_list = ['bbc','sst2','subj','agnews','trec','pc','cr','cardio']
...
if __name__ == '__main__':
    for name in dataset_list:
        try:
            ...
            batch_size = 4
            epochs = 20
            cnn = CNN(dims=300, w2v_path=w2v_path,fulldataset= False, max_seq_len=max_seq_len, batch_size=batch_size, epochs=epochs, chunk_size=1000)
